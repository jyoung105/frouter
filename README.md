...
- Runtime JS output: `dist/bin/`, `dist/lib/` (generated by `npm run build`)
- Test source of truth: `src/tests/`
- Compiled test output: `dist/tests/` (generated before test runs)
- Legacy paths (`bin/`, `lib/`, `tests/`) are compatibility wrappers only.
