...
const MODELS = [
  { id: 'meta/llama-3.1-8b-instruct', displayName: 'Llama 3.1 8B', providerKey: 'nvidia', tier: 'A+', aaIntelligence: 42 },
  { id: 'mistralai/mistral-small-3.2-24b-instruct:free', displayName: 'Mistral Small', providerKey: 'openrouter', tier: 'S', aaIntelligence: 60 },
  { id: 'google/gemma-3-27b-it', displayName: 'Gemma 3 27B', providerKey: 'nvidia', tier: 'B+', aaIntelligence: 30 },
];
